...
import { type ReactNode, type ReactElement, useCallback, useRef, useState, cloneElement } from "react";
...
const icons: Record<string, ReactNode> = {
  website: (
    <svg viewBox="0 0 305 305" fill="currentColor" stroke="none" aria-hidden="true">
      <g>
  ...
  instagram: (
    <svg viewBox="0 0 32 32" fill="currentColor" stroke="none" aria-hidden="true">
...
const shareIcons: Record<string, ReactNode> = {
  ...
  facebook: (
    <svg viewBox="0 0 16 16" className="h-5 w-5" fill="#1877F2" aria-hidden="true">
      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
    </svg>
  ),
  x: (
    <svg viewBox="0 0 16 16" className="h-5 w-5 text-black dark:text-white" fill="currentColor" aria-hidden="true">
      <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
    </svg>
  ),
  linkedin: (
    <svg viewBox="-143 145 512 512" className="h-5 w-5" fill="#0A66C2" aria-hidden="true">
  ...
  messenger: (
    <svg viewBox="0 0 512 512" className="h-5 w-5" aria-hidden="true">
      ...
      <linearGradient id="messenger-grad" x1="256" x2="256" y1="78.2" y2="441.2" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#00B2FF"/>
        <stop offset="1" stopColor="#006AFF"/>
      </linearGradient>
      <path fill="url(#messenger-grad)" d="M256 78.2c-102.4 0-181.8 75 -181.8 176.4c0 53 21.7 98.8 57 130.4a14.7 14.7 0 015 10.4l1 32.3a14.6 14.6 0 0020.4 12.9l36-16a14.5 14.5 0 019.8-.7a197.8 197.8 0 0052.6 7c102.4 0 181.8-75 181.8 -176.3S358.4 78.2 256 78.2z"/>
